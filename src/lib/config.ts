...
export const getConfiguration = (key: EnvironmentVariable): string | undefined => {
  return process.env[key];
};

export const isProduction = () => getConfiguration(EnvironmentVariable.NODE_ENV) === 'production';
